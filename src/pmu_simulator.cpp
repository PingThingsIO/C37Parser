...
* Client will request configuration first
*/
int main( int argc, char *argv[] )
{
    ...
    HEADER_Frame *my_header = new HEADER_Frame("Simulated PMU Test");
    
    // Create config packet
    my_config2->IDCODE_set(2);
    my_config2->SOC_set(1480444846);
    my_config2->FRACSEC_set(1443303576);
    my_config2->TIME_BASE_set(1000000);
    my_config2->DATA_RATE_set(15);
    
    my_config1->IDCODE_set(2);
    my_config1->SOC_set(1480444846);
    my_config1->FRACSEC_set(1443303576);
    my_config1->TIME_BASE_set(1000000);
    my_config1->DATA_RATE_set(15);
    
    my_dataframe->IDCODE_set(2);
    my_dataframe->SOC_set(1480444846);
    ...
    // true = float		    
    // coord 0 = rect
    PMU_Station pmu ("PMU 1st",666,false,true,true,true);
    PMU_Station pmu2 ("PMU 2nd",667,false,false,false,false);
...
void *tx_data(void *args){
  ...
  while(my_args->send_data_flag){
  	my_args->my_data->SOC_set(1480444846+i);
